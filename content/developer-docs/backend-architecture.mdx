...
description: Three-layer DEVS-FIRE integration architecture and responsibilities.
---

# DEVS-FIRE Backend Architecture

## Overview
This backend uses a strict three-layer server architecture for DEVS-FIRE integration:
...
All DEVS-FIRE/simulation routes return:
